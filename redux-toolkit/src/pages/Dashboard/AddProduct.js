...
import { addProduct } from "../../redux-toolkit-or-app/features/productSlice";
// import addProductData from "../../redux-vanila/thunk/products/addProductData";

const AddProduct = () => {
  const { register, handleSubmit } = useForm();
  const dispatch = useDispatch();
  const {postSuccess} = useSelector(state => state.products)
